...
Использованы следующие библиотеки/технологии:

- React с хуками
- Глобальный стейт через React Context API
- bootstrap
...
[https://uxcandy.com/~shapoval/test-task-backend/docs/v2.html](https://uxcandy.com/~shapoval/test-task-backend/docs/v2.html)
